<template>
  <div class="answer-module">
    ...
    <div class="main-content">
      <div class="dynamics">
        <div v-for="(dynamic, index) in dynamics" class="dynamic list-item">
          <h2 class="question-value">{{dynamic.question}}</h2>
          <div class="answer-wrapper">
            <user-card :user="userCard"></user-card>
            <div class="answer-content">
              <div v-if="!briefControll[index]" class="brief-answer">{{ dynamic.answer.value | htmlToText | chop }}
                <button v-if="!briefControll[index]" class="read-full" @click="toggleAnswer(index)">阅读全文
            ...
            <div class="func-bar">
              <button href="#" class="button-item light-button">
                <svg viewBox="0 0 20 18" width="9" height="16" aria-hidden="true" style="height: 16px; width: 9px;">
                  <title></title>
                  <g>
              ...
              <button v-if="briefControll[index]" class="button-item last-one" @click="toggleAnswer(index)">
                收起
