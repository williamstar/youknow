      ...
      <div class="content">
        ...
        <div class="dynamics">
          <div v-for="dynamic in dynamics"
            ...
            <img :src="dynamic.avatarLocalPath"
      ...
      <div class="youknow-live column">
        ...
        <ul>
          <li v-for="live in youknow_live">
            <a href="#"><img :src="live.avatarLocalPath"
                   alt="live.value"><span class="text-value">{{live.value}}</span></a>
          </li>
        </ul>
      </div>
      <div class="youknow-circledesk column">
        ...
        <ul>
          <li v-for="circle in youknow_circledesk">
            <a href="#"><img :src="circle.avatarLocalPath"
                   alt="circle.value"><span class="text-value">{{circle.value}}</span>
              <span v-if="circle.end"
                    class="final-time">还有{{circle.end}}天结束</span>
            </a>
          </li>
        </ul>
      </div>
      <div class="youknow-bookstore column">
        ...
        <ul>
          <li v-for="book in youknow_bookstore">
            <a href="#"><img :src="book.avatarLocalPath"
                   alt=""><span class="text-value">{{book.value}}</span></a>
          </li>
        </ul>
      </div>
    </div>
