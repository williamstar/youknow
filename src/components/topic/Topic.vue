  ...
  <div class="topic">
    <div class="topic-content">
      <div class="topic-header">
        ...
        <topic-list :topics="focus_topics"
                    :current-topic="currentTopic"
                    @switch="switchTopic"></topic-list>
      </div>
      <div class="topic-dynamic">
        <div class="dynamic-header">
          <span class="current-topic"><img :src="currentTopic.avatarLocalPath" class="current-avatar" width="40" height="40" :alt="currentTopic.value"><a href="#" class="current-topic-value">{{currentTopic.value}}</a></span>
        ...
        <div class="dynamics">
          <div v-for="dynamic in selectedDynamics"
               class="dynamic">
    ...
    <div class="extra-bar">
      ...
      <div class="recommend-topics">
        <div class="recommend-title">
          其他人关注的话题<a href="#"
             class="switch-topics">换一换</a>
        </div>
        <div class="recommend-topics-content">
          <div v-for="topic in recommend_topics"
            ...
            <img :src="topic.avatarLocalPath"
                 ...
                 alt="topic.value">
            <a href="#"
               class="topic-value">{{topic.value}}</a>
            <a href="#"
               class="focus">关注</a>
          </div>
        </div>
